...
SELECT
    ls.trajectory_id,
    ST_Contains(draw_cellstring(cs.cellstring_z13, 13), ls.geom) AS z13_contains,
    ST_Contains(draw_cellstring(cs.cellstring_z17, 17), ls.geom) AS z17_contains,
    ST_Contains(draw_cellstring(cs.cellstring_z21, 21), ls.geom) AS z21_contains
