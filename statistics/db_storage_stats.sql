...
SELECT
    ...
    pg_size_pretty(pg_relation_size('prototype2.trajectory_ls')) AS pt2_linestring_traj_data_size,
...
SELECT
    ...
    pg_size_pretty(pg_relation_size('prototype2.stop_poly')) AS pt2_polygon_stop_data_size,
