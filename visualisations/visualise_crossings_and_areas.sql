...
SELECT
    ...
    area_cs.name,
    area_poly.geom,
    draw_cellstring(cellstring_z21, 21) as cellstring_z21,
    draw_cellstring(cellstring_z17, 17) as cellstring_z17,
    draw_cellstring(cellstring_z13, 13) as cellstring_z13
